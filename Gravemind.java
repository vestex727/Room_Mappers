...
public class Gravemind {
    ...
    private static boolean SensorIsOn = false;
            ...
            try {
                ...
                while (true) {
                    ...
                    if (sync == 0xAA) { // Confirm sync byte received
                        ...
                        movements.add(new Movement(ticksLeft/100, SensorIsOn, direction));
                        // Print values to console
                        System.out.printf("Received -> Direction: %s | mm: %d | sense: %d%n", direction.name(), ticksLeft, ticksRight);
                    }
                }
            } catch (IOException e) {
    ...
    static void showMap(){
        ...
        frame.add(map);
        frame.setSize(10000, 10000);  // Set window size
        frame.setVisible(true);
    }

    static void simulateSensor(KeyEvent e){
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(Gravemind::createAndShowGUI); // Start GUI on event-dispatch thread
    }
}
